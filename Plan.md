...
- Front panel is 3 layers: Base layer is a 3D print to which components are mounted, middle layer is a printed graphic, outer layer is a clear piece of acrylic. This sandwich design allows for the graphic layer to be exchanged in case I move and a different stop is nearby, or I move cities and the transit agency changes.
